...
(function(global) {
  ...
  var Brain = function(num_states, num_actions, opt) {
    ...
    this.epsilon_initial = typeof opt.epsilon_initial !== 'undefined' ? opt.epsilon_initial : 1
    ...
    this.value_net.makeLayers(layer_defs);//which add activation layers and dropping layers
  ...
  Brain.prototype = {
    ...
    forward: function(input_array) {
      ...
      if(this.forward_passes > this.temporal_window) {
        ...
        if(this.learning) {
          ...
          this.epsilon = Math.min(this.epsilon_initial, Math.max(this.epsilon_min, 1.0-(this.age - this.learning_steps_burnin)/(this.learning_steps_total - this.learning_steps_burnin))); 
        } else {
    ...
    backward: function(reward) {
      ...
      if(this.forward_passes > this.temporal_window + 1) {
        ...
        var n = this.window_size;
        e.state0 = this.net_window[n-1];
        e.action0 = this.action_window[n-1];
        e.reward0 = this.reward_window[n-1];
        e.state1 = this.net_window[n];
        if(this.experience.length < this.experience_size) {
          this.experience.push(e);
          this.recorder.push([this.last_input_array,e.reward0, e.action0]);//,'s1', e.state1,'r', e.reward0,'a', e.action0];
          ...
          localStorage.setItem("myItem", this.recorder);
          document.getElementById("result").innerHTML = localStorage.getItem("myItem");
        } else {
