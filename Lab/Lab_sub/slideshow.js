...
slideShow[0] = ["Projects_sub/MarkovIndepModel.png", "Markov + Independence Model"]
slideShow[1] = ["Projects_sub/ten_grad_hot_map.png", "Spectral Estimation"]
slideShow[2] = ["Projects_sub/mmsb.png", "Mixed Membership Model"]
slideShow[3] = ["Projects_sub/nmi.png", "Fast Detection of Overlapping Communities via Online Tensor Methods"]
slideShow[4] = ["Projects_sub/yelp.png", "Yelp Dataset - Most Accurately Recovered Categories"]
